...
public class ARV2 {
    ...
    private final float maxBeamLength;
    private final float beamInterval;
    ...
    private void renderSingleModel(PoseStack ps, VertexConsumer consumer, float[] rgb, float alpha) {
        ...
        float[] afloat = new float[]{1.0F, 1.0F, 1.0F, 1.0F};
        int[] aint = new int[]{15728880, 15728880, 15728880, 15728880};
    ...
    public boolean checkCollision(Entity target) {
        float currentTick = (float)this.ticksExisted;
